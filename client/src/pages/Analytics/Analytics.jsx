...
export default function Analytics() {
  ...
  let filterText = `Year: ${selectedYear || "All"}\nMonth: ${selectedMonth !== "" ? months[selectedMonth] : "All"}`;
  ...
  const docDefinition = {
    ...
    content: [
      { text: "Analytics Report", style: "header", alignment: "center", margin: [0, 0, 0, 20] },
      { text: `Owner : ${user.name[0].toUpperCase()+user.name.slice(1)}`, style: "subheader", margin: [0, 0, 0, 5] },
      { text: "Filters", style: "subheader", margin: [0, 0, 0, 5] },
      { text: filterText, margin: [0, 0, 0, 15] },

      { text: "Income Categories", style: "subheader", color: "#00C49F", margin: [0, 10, 0, 5] },
      {
        table: { 
          widths: ["*", "*"], 
        ...
        layout: {
          fillColor: (rowIndex) => rowIndex === 0 ? incomeTable.headerColor : (rowIndex === incomeTable.body.length - 1 ? "#DFF2E1" : (rowIndex % 2 === 0 ? "#F7F7F7" : null)),
          hLineColor: "#ccc",
          vLineColor: "#ccc",
          paddingTop: () => 5,
          paddingBottom: () => 5,
      ...
      { text: "Expense Categories", style: "subheader", color: "#FF4560", margin: [0, 20, 0, 5] },
      {
        table: { 
          widths: ["*", "*"], 
        ...
        layout: {
          fillColor: (rowIndex) => rowIndex === 0 ? expenseTable.headerColor : (rowIndex === expenseTable.body.length - 1 ? "#FDE2E2" : (rowIndex % 2 === 0 ? "#F7F7F7" : null)),
          hLineColor: "#ccc",
          vLineColor: "#ccc",
          paddingTop: () => 5,
          paddingBottom: () => 5,
      ...
      { text: "Monthly Income vs Expense", style: "subheader", margin: [0, 20, 0, 5] },
      {
        table: { 
          widths: ["*", "*", "*"], 
          body: barTableBody 
        ...
        layout: {
          fillColor: (rowIndex) => rowIndex === 0 ? "#00C49F" : (rowIndex % 2 === 0 ? "#F7F7F7" : null),
          hLineColor: "#ccc",
          vLineColor: "#ccc",
          paddingTop: () => 5,
          paddingBottom: () => 5,
